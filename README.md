...
edit this file directly or use `/temp` and `/model` commands.
...
**responses too slow**  
try a smaller model or reduce `num_ctx`

---

## why "g1sh"?

pronounced like "gish" (soft g). name comes from my nickname (green → gish → g1sh).
